          ...
          <GlassCard className="w-full">
            <div className="text-center mb-8">
              ...
              <p className="mt-2 text-white/70">
                Join us on your journey to better relationships
              </p>
            </div>
            ...
            <div className="relative py-3 sm:py-5">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 py-1 text-white/70 bg-black/50 backdrop-blur-sm rounded-full">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <motion.span
                    ...
                    className="absolute right-3 top-3 text-white/50 cursor-pointer hover:text-white/70"
                  >
                    {showPassword ? (
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="flex items-start gap-3">
                <div className="flex items-center h-5">
                  <input
                    ...
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 bg-white/10 border-white/20 rounded cursor-pointer"
                  />
                </div>
                <div>
