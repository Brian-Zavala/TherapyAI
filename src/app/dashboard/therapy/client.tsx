        ...
        React.createElement("div", {
          ...
          React.createElement("div", {
            ...
            React.createElement("div", {
              ...
              !isSessionActive ? 
                React.createElement("div", {
                  ...
                  React.createElement("button", {
                    ...
                    className: `flex items-center rounded-lg px-3 py-1.5 text-xs font-medium transition-colors duration-300 ${
                      isSessionActive 
                        ? 'bg-indigo-700/30 text-indigo-300 hover:bg-indigo-700/40' 
              ...
              React.createElement("div", {
                ...
                React.createElement("div", {
                  ...
                  React.createElement("h2", {
                    key: "therapist-name",
                    className: `text-xl font-bold transition-colors duration-500 mb-1 ${isSessionActive ? 'text-white' : 'text-indigo-800'}`
              ...
              // Status indicator (when active) - centered
              isSessionActive ? 
                React.createElement("div", {
                  key: "status",
            ...
            React.createElement("div", {
              ...
              isSessionActive ? 
                React.createElement("div", {
                  key: "active-info",
                  className: "p-6 rounded-xl mb-8 bg-gradient-to-br from-indigo-600/20 to-purple-600/20 border border-indigo-500/30 shadow-inner"
                }, [
                ...
                React.createElement("div", {
                  key: "welcome-info",
                  className: "space-y-5 mb-8 text-center max-w-xl mx-auto"
                }, [
                  // Decorative element
                  React.createElement("div", {
                    key: "decorative-line",
                  ...
                  React.createElement("p", {
                    key: "cta-message",
                    className: "text-indigo-600 font-medium py-2 px-4 border border-indigo-100 rounded-lg bg-indigo-50/50 inline-block"
