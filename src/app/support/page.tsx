            ...
            <GlassCard className="p-8 ">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl text-white placeholder-white/50 focus:outline-none focus:border-blue-500"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    rows={6}
                    className="w-full px-4 py-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl text-white placeholder-white/50 focus:outline-none focus:border-blue-500 resize-none"
              ...
              <div className="mt-8 border-t border-white/10 pt-6">
                ...
                <div className="space-y-2 text-white/70">
                  ...
                  <p>
                    Response Time: We aim to respond to all inquiries within 24
