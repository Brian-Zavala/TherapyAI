        ...
        >
          {option.recommended && (
            <div className="absolute -top-2 -right-2">
              <span className="inline-flex items-center px-2 py-1 text-xs font-medium bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-full shadow-lg">
                Recommended
              </span>
            </div>
          )}
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <div className={`text-sm font-medium mb-1 ${
                value === option.value ? 'text-blue-300' : 'text-gray-400'
              }`}>
                {option.duration}
              </div>
