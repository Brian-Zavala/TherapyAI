              ...
              {option.recommended && (
                <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                  <motion.span 
                    ...
                    className={`inline-flex items-center gap-1 px-3 py-1 text-xs font-bold bg-gradient-to-r ${colors.badge} text-white rounded-full shadow-lg`}
                  >
                    <TrendingUp size={12} />
                    Most Successful
                  </motion.span>
      ...
      {value === 'yes' && (
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm text-green-300 font-medium mb-1">Great choice!</p>
      ...
      {value === 'no' && (
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              <p className="text-sm text-blue-300 font-medium mb-1">Flexibility is key!</p>
              <p className="text-xs text-gray-400">
