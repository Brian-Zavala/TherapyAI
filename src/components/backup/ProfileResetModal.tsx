    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div 
              className="relative w-full max-w-lg bg-gradient-to-br from-gray-900/95 via-slate-800/95 to-gray-900/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-700/50"
