        ...
        >
          ...
          >
            ...
            <div className="p-4 sm:p-6">
              {/* Member Info */}
              <div className="bg-blue-600/20 rounded-xl p-3 sm:p-4 mb-4 sm:mb-6 border border-blue-600/30">
              ...
              <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3">
                <button
                  onClick={onClose}
                  className="w-full sm:flex-1 px-3 sm:px-4 py-2.5 sm:py-3 border border-gray-600/50 text-gray-300 rounded-xl hover:bg-gray-700/30 hover:border-gray-500/60 transition-all duration-200 font-medium text-xs sm:text-base"
                  disabled={isLoading}
                >
                  Cancel
                </button>
                <motion.button
                  ...
                  onClick={onConfirm}
                  disabled={isLoading}
                  className="w-full sm:flex-1 px-3 sm:px-4 py-2.5 sm:py-3 bg-red-500 text-white rounded-xl hover:bg-red-600 transition-all duration-200 font-medium flex items-center justify-center gap-2 text-xs sm:text-base"
                >
                  {isLoading ? (
