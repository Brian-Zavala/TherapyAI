...
export const LampContainer = ({
  ...
  return (
    ...
    >
      <div className="relative top-44 min-h-10 flex w-full flex-1 scale-y-[72%] lg:scale-x-[200%] items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[36rem] bg-gradient-conic from-blue-400 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
